...
<div class="layout">
  ...
  <div class="panel form-panel">
    ...
    <div class="row">
      <div class="field">
        <label for="num_candidates">Num candidates</label>
        <input type="number" id="num_candidates" value="1" min="1" max="10">
      </div>
      <div class="field">
...
async function runGrasp() {
  ...
  fd.append('num_candidates', document.getElementById('num_candidates').value);
